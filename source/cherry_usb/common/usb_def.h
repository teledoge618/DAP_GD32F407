...
#define USB_GET_ENDPOINT_TYPE(x) \
    ((x & USB_ENDPOINT_TYPE_MASK) >> USB_ENDPOINT_TYPE_SHIFT)
...
#define USB_MAXPACKETSIZE_ADDITIONAL_TRANSCATION_NONE \
    (0 << USB_MAXPACKETSIZE_ADDITIONAL_TRANSCATION_SHIFT)
#define USB_MAXPACKETSIZE_ADDITIONAL_TRANSCATION_ONE \
    (1 << USB_MAXPACKETSIZE_ADDITIONAL_TRANSCATION_SHIFT)
#define USB_MAXPACKETSIZE_ADDITIONAL_TRANSCATION_TWO \
    (2 << USB_MAXPACKETSIZE_ADDITIONAL_TRANSCATION_SHIFT)
#define USB_MAXPACKETSIZE_ADDITIONAL_TRANSCATION_MASK \
    (3 << USB_MAXPACKETSIZE_ADDITIONAL_TRANSCATION_SHIFT)
#define USB_GET_MAXPACKETSIZE(x) \
    ((x & USB_MAXPACKETSIZE_MASK) >> USB_MAXPACKETSIZE_SHIFT)
#define USB_GET_MULT(x)                                     \
    ((x & USB_MAXPACKETSIZE_ADDITIONAL_TRANSCATION_MASK) >> \
...
#define USB_OTG_FEATURE_A_ALT_HNP_SUPPORT \
    5 /* Another port on the A device supports HNP */
