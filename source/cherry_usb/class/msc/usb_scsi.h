...
struct scsiresp_inquiry_s {
    ...
    uint8_t qualtype; /* 0: Bits 5-7: Peripheral qualifier; Bits 0-4: Peripheral
                         device type */
...
struct scsiresp_cachingmodepage_s {
    ...
    uint8_t priority;  /* 3: Bits 4-7: Demand read retention priority; Bits 0-3:
...
struct scsicmd_read6_s {
    ...
    uint8_t mslba;  /* 1: Bits 5-7: reserved; Bits 0-6: MS Logical Block Address
                       (LBA) */
...
struct scsicmd_startstopunit_s {
    ...
    uint8_t pc;  /* 4: Bits 4-7: Power condition, Bit 2: NO_FLUSH, Bit 1: LOEJ,
                    Bit 0: START */
    uint8_t control; /* 5: Control */
};
...
struct scsicmd_read12_s {
    ...
    uint8_t groupno;   /* 10: Bit 7: restricted; Bits 5-6: reserved; Bits 0-6:
                          group number */
...
struct scsicmd_verify12_s {
    ...
    uint8_t groupno; /* 10: Bit 7: restricted; Bits 5-6: Reserved, Bits 0-4:
                        Group number */
    uint8_t control; /* 11: Control */
};
