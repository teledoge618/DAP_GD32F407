...
static int cdc_acm_class_interface_request_handler(
    ...
    switch (setup->bRequest) {
        case CDC_REQUEST_SET_LINE_CODING:
            ...
            ULOG_DEBUG("Set intf:%d linecoding <%d %d %s %s>\r\n", intf_num,
        ...
        case CDC_REQUEST_SET_CONTROL_LINE_STATE:
            ...
            ULOG_DEBUG("Set intf:%d DTR 0x%x,RTS 0x%x\r\n", intf_num, dtr, rts);
        ...
        case CDC_REQUEST_GET_LINE_CODING:
            ...
            *len = 7;
            ULOG_DEBUG("Get intf:%d linecoding %d %d %d %d\r\n", intf_num,
        ...
        case CDC_REQUEST_SEND_BREAK:
            ...
            break;
        default:
            ULOG_WARN("Unhandled CDC Class bRequest 0x%02x\r\n",
                     setup->bRequest);
            return -1;
    }
...
struct usbd_interface *usbd_cdc_acm_init_intf(uint8_t busid,
...
__WEAK void usbd_cdc_acm_set_line_coding(uint8_t busid, uint8_t intf,
                                         struct cdc_line_coding *line_coding) {
    (void)busid;
    (void)intf;
    (void)line_coding;
...
__WEAK void usbd_cdc_acm_get_line_coding(uint8_t busid, uint8_t intf,
                                         struct cdc_line_coding *line_coding) {
    (void)busid;
    (void)intf;
