...
/* Register desc api */
void usbd_hid_descriptor_register(uint8_t busid, uint8_t intf_num,
                                  const uint8_t *desc);
void usbd_hid_report_descriptor_register(uint8_t busid, uint8_t intf_num,
                                         const uint8_t *desc,
                                         uint32_t desc_len);
...
void usbd_hid_set_report(uint8_t busid, uint8_t intf, uint8_t report_id,
                         ...
                         uint32_t report_len);
void usbd_hid_set_idle(uint8_t busid, uint8_t intf, uint8_t report_id,
                       uint8_t duration);
